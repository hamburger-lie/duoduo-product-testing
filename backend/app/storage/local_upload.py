...
# Persistent directory for product images.
# Override with LOCAL_STORAGE_ROOT env var; defaults to /app/data/product_images
# so it can be mounted as a Docker volume and survive container restarts.
STORAGE_ROOT: Path = Path(
    os.environ.get("LOCAL_STORAGE_ROOT", "/app/data/product_images")
)
